...
<div id="page-container">
  <div id="main-content">
    <article id="post-377644" className="post-377644 page type-page status-publish hentry">
      <div className="entry-content">
        <div className="et-l et-l--post">
          <div className="et_builder_inner_content et_pb_gutters3">
                    ...
                    <div className="et_pb_code_inner">
                      <div className="wonderpluginaudio" id="wonderpluginaudio-441" data-audioplayerid={441} data-width={48} data-height={600} data-skin="button48" data-progressinbar="true" data-showinfo="false" data-showimage="false" data-autoplay="false" data-random="false" data-autoresize="false" data-responsive="false" data-showtracklist="false" data-tracklistscroll="true" data-showprogress="false" data-showprevnext="false" data-showloop="false" data-stopotherplayers="true" data-preloadaudio="true" data-showtracklistsearch="false" data-saveposincookie="false" data-wptracklist="false" data-removeinlinecss="true" data-showtime="false" data-showvolume="false" data-showvolumebar="true" data-showliveplayedlist="false" data-showtitleinbar="false" data-showloading="false" data-enablega="false" data-titleinbarscroll="true" data-donotinit="false" data-addinitscript="false" data-imagewidth={100} data-imageheight={100} data-loop={1} data-tracklistitem={10} data-titleinbarwidth={80} data-gatrackingid data-playbackrate={1} data-playpauseimage="playpause-48-48-1.png" data-playpauseimagewidth={48} data-playpauseimageheight={48} data-cookiehours={240} data-prevnextimage="prevnext-24-24-0.png" data-prevnextimagewidth={24} data-prevnextimageheight={24} data-volumeimage="volume-24-24-0.png" data-volumeimagewidth={24} data-volumeimageheight={24} data-liveupdateinterval={10000} data-maxplayedlist={8} data-playedlisttitle="Last Tracks Played" data-loopimage="loop-24-24-0.png" data-loopimagewidth={24} data-loopimageheight={24} data-infoformat="<div class='amazingaudioplayer-info-title'>%ARTIST% %ALBUM%</div>
                        ...
                        <ul className="amazingaudioplayer-audios" style={{display: 'none'}}>
                          <li data-artist data-title="Shania Twain From This Moment On" data-album data-info="&quot;Shania Twain From This Moment On&quot;." data-image="https://ngantenstory.com/wp-includes/images/media/audio.png" data-duration={234}>
                            <div className="amazingaudioplayer-source" data-src="https://ngantenstory.com/wp-content/uploads/2022/01/Shania-Twain-From-This-Moment-On.mp3" data-type="audio/mpeg" />
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="et_pb_module_inner">
                      <h1>
                        <svg id="dvmdtpsvg" width={130} height="100%" viewBox="0 -17.5 130 17.5">
                          <path id="mjXmeMJoSROJHvsFeKwshYaSQcsvNpet" className="mainPath" d="M0 0 C43.333333333333 -23.333333333333 86.666666666667 -23.333333333333 130 0 " />
                          ...
                          <text dy="-0.1em" dx="2px 2px 2px 2px 2px 2px 2px 2px 2px 2px 2px ">
                            <textPath id="textPath" xlinkHref="#mjXmeMJoSROJHvsFeKwshYaSQcsvNpet" startOffset="50%">Our Wedding</textPath>
                          </text>
                        </svg>
                      </h1>
                    </div>
              ...
              <div className="et_pb_row et_pb_row_3">
                <div className="et_pb_column et_pb_column_4_4 et_pb_column_3  et_pb_css_mix_blend_mode_passthrough et-last-child">
                  <div className="et_pb_module et_pb_image et_pb_image_0 et_animated et-waypoint">
                    <span className="et_pb_image_wrap "><img decoding="async" width={250} height={250} src="../wp-content/uploads/2020/02/Bird.png" alt title="Bird" srcSet="https://ngantenstory.com/wp-content/uploads/2020/02/Bird.png 250w, https://ngantenstory.com/wp-content/uploads/2020/02/Bird-150x150.png 150w" sizes="(max-width: 250px) 100vw, 250px" className="wp-image-780" /></span>
                  </div>
              ...
              <div className="et_pb_row et_pb_row_4">
                  ...
                  <div className="et_pb_module et_pb_blurb et_pb_blurb_0 et_animated  et_pb_text_align_left  et_pb_blurb_position_top et_pb_bg_layout_light">
                    <div className="et_pb_blurb_content">
                      <div className="et_pb_blurb_container">
                        <h4 className="et_pb_module_header"><span>Nesya Octora Tiranda</span>
                        </h4>
                        <div className="et_pb_blurb_description">
                          <p>Putri dari<br />Bapak Muchammad Basri<br />&amp; Ibu Siswati
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="et_pb_column et_pb_column_1_3 et_pb_column_6  et_pb_css_mix_blend_mode_passthrough et-last-child">
                  <div className="et_pb_module et_pb_blurb et_pb_blurb_1 et_animated  et_pb_text_align_right  et_pb_blurb_position_top et_pb_bg_layout_light">
                    <div className="et_pb_blurb_content">
                      <div className="et_pb_blurb_container">
                        <h4 className="et_pb_module_header"><span>Gandhi Bayu Koesmawan</span>
                        </h4>
                        <div className="et_pb_blurb_description">
                          <p>Putra dari<br />Bapak Rudy<br />&amp; Ibu Nurmala</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="et_pb_section et_pb_section_4 et_section_regular section_has_divider et_pb_bottom_divider et_pb_top_divider">
              <div className="et_pb_top_inside_divider et-no-transition" />
              <div className="et_pb_with_border et_pb_row et_pb_row_5 et_animated">
                  ...
                  <div className="et_pb_module et_pb_blurb et_pb_blurb_2 et_animated  et_pb_text_align_center  et_pb_blurb_position_top et_pb_bg_layout_dark">
                    <div className="et_pb_blurb_content">
                      <div className="et_pb_blurb_container">
                        ...
                        <div className="et_pb_blurb_description">
                          <p>Sabtu, 15 April 2023<br />08.00 WITA s/d
                            selesai<br /><strong>Hotel Conrad Bali</strong><br />Jl.
                            Pratama No.168, Tanjung Benoa,<br />Kuta Selatan, Badung,
                            Bali 80363</p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="et_pb_column et_pb_column_1_2 et_pb_column_8  et_pb_css_mix_blend_mode_passthrough et-last-child">
                  <div className="et_pb_module et_pb_blurb et_pb_blurb_3 et_animated  et_pb_text_align_center  et_pb_blurb_position_top et_pb_bg_layout_dark">
                    <div className="et_pb_blurb_content">
                      <div className="et_pb_blurb_container">
                        ...
                        <div className="et_pb_blurb_description">
                          <p>Sabtu, 15 April 2023<br />11:00 s/d 15:00
                            WITA<br /><strong>Hotel Conrad Bali</strong><br />Jl.
                            Pratama No.168, Tanjung Benoa,<br />Kuta Selatan, Badung,
                            Bali 80363</p>
                        </div>
                      </div>
                  ...
                  <div className="et_pb_button_module_wrapper et_pb_button_1_wrapper et_pb_button_alignment_center et_pb_module ">
                    <a className="et_pb_button et_pb_button_1 et_pb_bg_layout_light" href="https://goo.gl/maps/iqHMxcKh1LtdWAsq8" target="_blank" data-icon="">Google Maps</a>
                  </div>
                </div>
              </div>
              <div className="et_pb_bottom_inside_divider et-no-transition" />
            ...
            <div className="et_pb_section et_pb_section_5 et_pb_with_background et_section_regular">
              <div className="et_pb_row et_pb_row_6">
                <div className="et_pb_column et_pb_column_4_4 et_pb_column_9  et_pb_css_mix_blend_mode_passthrough et-last-child">
                  <div className="et_pb_module et_pb_countdown_timer et_pb_countdown_timer_0 et_animated et_pb_no_bg et_pb_bg_layout_light" data-end-timestamp={1682874000}>
            ...
            <div id="dana" className="et_pb_section et_pb_section_7 popup et_pb_with_background et_section_regular">
              ...
              <div className="et_pb_with_border et_pb_row et_pb_row_10">
                <div className="et_pb_column et_pb_column_4_4 et_pb_column_14  et_pb_css_mix_blend_mode_passthrough et-last-child">
                  ...
                  <div className="et_pb_button_module_wrapper et_pb_button_2_wrapper et_pb_button_alignment_center et_pb_module ">
                    <a className="et_pb_button et_pb_button_2 copy-text et_pb_bg_layout_light" href="#" data-icon="">Copy Number</a>
                  </div>
                </div>
              </div>
            ...
            <div id="hadiah" className="et_pb_section et_pb_section_8 popup et_section_regular">
              ...
              <div className="et_pb_with_border et_pb_row et_pb_row_13">
                <div className="et_pb_column et_pb_column_4_4 et_pb_column_17  et_pb_css_mix_blend_mode_passthrough et-last-child">
                  ...
                  <div className="et_pb_button_module_wrapper et_pb_button_4_wrapper et_pb_button_alignment_center et_pb_module ">
                    <a className="et_pb_button et_pb_button_4 copy-text et_pb_bg_layout_light" href="#" data-icon="">Copy Address</a>
                  </div>
                </div>
              </div>
            </div>
            <div className="et_pb_section et_pb_section_9 et_section_regular section_has_divider et_pb_bottom_divider et_pb_top_divider">
              <div className="et_pb_top_inside_divider et-no-transition" />
            ...
            <div className="et_pb_with_border et_pb_section et_pb_section_10 et_section_regular section_has_divider et_pb_bottom_divider et_pb_top_divider">
                  ...
                  <div className="et_pb_with_border et_pb_module et_pb_comments_0 lang-id et_pb_comments_module et_pb_bg_layout_light et_pb_no_avatar et_pb_no_reply_button et_pb_no_comments_count" data-icon="">
                    <section id="comment-wrap">
                      ...
                      <ol className="commentlist clearfix">
                        <li className="comment even thread-even depth-1 et-pb-non-builder-comment" id="li-comment-197938">
                          <article id="comment-197938" className="comment-body clearfix">
                        ...
                        <li className="comment odd alt thread-odd thread-alt depth-1 et-pb-non-builder-comment" id="li-comment-197922">
                          <article id="comment-197922" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                        ...
                        <li className="comment even thread-even depth-1 et-pb-non-builder-comment" id="li-comment-197906">
                          <article id="comment-197906" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                        ...
                        <li className="comment odd alt thread-odd thread-alt depth-1 et-pb-non-builder-comment" id="li-comment-197890">
                          <article id="comment-197890" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                        ...
                        <li className="comment even thread-even depth-1 et-pb-non-builder-comment" id="li-comment-197874">
                          <article id="comment-197874" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                        ...
                        <li className="comment odd alt thread-odd thread-alt depth-1 et-pb-non-builder-comment" id="li-comment-197858">
                          <article id="comment-197858" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                        ...
                        <li className="comment even thread-even depth-1 et-pb-non-builder-comment" id="li-comment-197842">
                          <article id="comment-197842" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                              <span className="fn">Herdian</span> <span className="comment_date">
                                on January 2, 2023 at 12:24 am </span>
                            </div>
                            <div className="comment_area">
                              <div className="comment-content clearfix">
                        ...
                        <li className="comment odd alt thread-odd thread-alt depth-1 et-pb-non-builder-comment" id="li-comment-197813">
                          <article id="comment-197813" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                              <span className="fn">Indriaya</span> <span className="comment_date">
                                on January 2, 2023 at 12:18 am </span>
                            </div>
                            <div className="comment_area">
                              <div className="comment-content clearfix">
                        ...
                        <li className="comment even thread-even depth-1 et-pb-non-builder-comment" id="li-comment-197810">
                          <article id="comment-197810" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                        ...
                        <li className="comment odd alt thread-odd thread-alt depth-1 et-pb-non-builder-comment" id="li-comment-197781">
                          <article id="comment-197781" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                              <span className="fn">Karunia</span> <span className="comment_date">
                                on January 2, 2023 at 12:04 am </span>
                            </div>
                            <div className="comment_area">
                              <div className="comment-content clearfix">
                        ...
                        <li className="comment even thread-even depth-1 et-pb-non-builder-comment" id="li-comment-197765">
                          <article id="comment-197765" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                              <span className="fn">Lelana</span> <span className="comment_date">
                                on January 2, 2023 at 12:02 am </span>
                            </div>
                            <div className="comment_area">
                              <div className="comment-content clearfix">
                        ...
                        <li className="comment odd alt thread-odd thread-alt depth-1 et-pb-non-builder-comment" id="li-comment-197749">
                          <article id="comment-197749" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                        ...
                        <li className="comment even thread-even depth-1 et-pb-non-builder-comment" id="li-comment-197733">
                          <article id="comment-197733" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                        ...
                        <li className="comment odd alt thread-odd thread-alt depth-1 et-pb-non-builder-comment" id="li-comment-197717">
                          <article id="comment-197717" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                              <span className="fn">Ningrum ❤️</span> <span className="comment_date">
                                on January 1, 2023 at 11:56 pm </span>
                            </div>
                            <div className="comment_area">
                              <div className="comment-content clearfix">
                        ...
                        <li className="comment even thread-even depth-1 et-pb-non-builder-comment" id="li-comment-197715">
                          <article id="comment-197715" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                        ...
                        <li className="comment odd alt thread-odd thread-alt depth-1 et-pb-non-builder-comment" id="li-comment-197685">
                          <article id="comment-197685" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                              <span className="fn">❤️ Raditya ❤️</span> <span className="comment_date">
                                on January 1, 2023 at 11:49 pm </span>
                            </div>
                            <div className="comment_area">
                              <div className="comment-content clearfix">
...
if (document.getElementById('bronze')) {
    ReactDOM.render(<Bronze/>, document.getElementById('bronze'));
}
