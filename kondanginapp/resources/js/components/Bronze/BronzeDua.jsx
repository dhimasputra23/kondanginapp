                    ...
                    <div className="et_pb_blurb_content">
                      <div className="et_pb_blurb_container">
                        ...
                        <div className="et_pb_blurb_description">
                          <p>Putri dari<br />Bapak {a ? <span>{state.undangan.data.profilPasangans[1].nama_bapak}</span> : []}<br />&amp; Ibu {a ? <span>{state.undangan.data.profilPasangans[1].nama_ibu}</span> : []}
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="et_pb_with_border et_pb_row et_pb_row_5 et_animated">
                ...
                <div className="et_pb_column et_pb_column_1_2 et_pb_column_8  et_pb_css_mix_blend_mode_passthrough et-last-child">
                  ...
                  <div className="et_pb_button_module_wrapper et_pb_button_1_wrapper et_pb_button_alignment_center et_pb_module ">
                    <a className="et_pb_button et_pb_button_1 et_pb_bg_layout_light" href={a? `https://www.google.com/maps/place/${a.subAcaras[0].lattitude},${a.subAcaras[0].longitude}` : '#'} target="_blank" data-icon="">Google Maps</a>
                  </div>
                </div>
              </div>
              <div className="et_pb_bottom_inside_divider et-no-transition" />
...
export default BronzeDua

if (document.getElementById('bronzeDua')) {
    ReactDOM.render(
      <Provider store={store}>
            <BronzeDua />
        </Provider>, 
      document.getElementById('bronzeDua'));
}
