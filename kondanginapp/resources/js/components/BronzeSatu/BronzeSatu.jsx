                  ...
                  <div className="et_pb_module et_pb_code et_pb_code_1">
                    ...
                    <div class='amazingaudioplayer-info-description'>%INFO%</div>" data-jsfolder="https://hi.ngantenstory.com/wp-content/plugins/wonderplugin-audio/engine/" style={{display: 'block', position: 'relative', margin: '0 auto', width: 48, height: 'auto'}}>
                        <ul className="amazingaudioplayer-audios" style={{display: 'none'}}>
                          <li data-artist data-title="RUELLE - I Get To Love You" data-album data-info="&quot;RUELLE - I Get To Love You&quot;." data-image="https://hi.ngantenstory.com/wp-includes/images/media/audio.png" data-duration={232}>
                            <div className="amazingaudioplayer-source" data-src="https://hi.ngantenstory.com/wp-content/uploads/2023/02/RUELLE-I-Get-To-Love-You.mp3" data-type="audio/mpeg" />
                          </li>
                        </ul>
                      </div>
                    </div>
              ...
              <div className="et_pb_with_border et_pb_row et_pb_row_3">
                <div className="et_pb_column et_pb_column_4_4 et_pb_column_3  et_pb_css_mix_blend_mode_passthrough et-last-child">
                  <div className="et_pb_module et_pb_image et_pb_image_0 et_animated et-waypoint">
                    <span className="et_pb_image_wrap "><img decoding="async" width={250} height={250} src="https://hi.ngantenstory.com/wp-content/uploads/2023/02/Bird.png" alt title="Bird" srcSet="https://hi.ngantenstory.com/wp-content/uploads/2023/02/Bird.png 250w, https://hi.ngantenstory.com/wp-content/uploads/2023/02/Bird-150x150.png 150w" sizes="(max-width: 250px) 100vw, 250px" className="wp-image-289" /></span>
                  </div>
                  ...
                  <div className="et_pb_module et_pb_blurb et_pb_blurb_0 et_animated  et_pb_text_align_center  et_pb_blurb_position_top et_pb_bg_layout_light">
                    <div className="et_pb_blurb_content">
                      <div className="et_pb_blurb_container">
                        <h4 className="et_pb_module_header"><span>Nada Pertiwi, S.E</span></h4>
                        <div className="et_pb_blurb_description">
                          <p>Putri dari<br />Bapak Erwinta<br />&amp; Ibu Poppy</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="et_pb_module et_pb_blurb et_pb_blurb_1 et_animated  et_pb_text_align_center  et_pb_blurb_position_top et_pb_bg_layout_light">
                    <div className="et_pb_blurb_content">
                      <div className="et_pb_blurb_container">
                        <h4 className="et_pb_module_header"><span>Rio Hendri Pranata, S.H</span>
                        </h4>
                        <div className="et_pb_blurb_description">
                          <p>Putra dari<br />Bapak Zulfikar<br />&amp; Ibu Neni</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="et_pb_with_border et_pb_row et_pb_row_4">
                <div className="et_pb_column et_pb_column_4_4 et_pb_column_4  et_pb_css_mix_blend_mode_passthrough et-last-child">
                  <div className="et_pb_module et_pb_blurb et_pb_blurb_2 et_animated  et_pb_text_align_center  et_pb_blurb_position_top et_pb_bg_layout_light">
                    <div className="et_pb_blurb_content">
                      <div className="et_pb_blurb_container">
                        ...
                        <div className="et_pb_blurb_description">
                          <p>Sabtu, 13 Mei 2023<br />10.00 WITA<br /><strong>The Westin
                              Jakarta</strong><br />Jl. H. R. Rasuna Said
                            RT.2/RW.5,<br />Karet Kuningan, Kec. Setiabudi, Jakarta</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="et_pb_module et_pb_blurb et_pb_blurb_3 et_animated  et_pb_text_align_center  et_pb_blurb_position_top et_pb_bg_layout_light">
                    <div className="et_pb_blurb_content">
                      <div className="et_pb_blurb_container">
                        ...
                        <div className="et_pb_blurb_description">
                          <p>Sabtu, 13 Mei 2023<br />11.00 s/d 14.00 WITA<br /><strong>The
                              Westin Jakarta</strong><br />Jl. H. R. Rasuna Said
                            RT.2/RW.5,<br />Karet Kuningan, Kec. Setiabudi, Jakarta</p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="et_pb_button_module_wrapper et_pb_button_1_wrapper et_pb_button_alignment_center et_pb_module ">
                    <a className="et_pb_button et_pb_button_1 et_animated et_pb_bg_layout_light" href="https://goo.gl/maps/iqHMxcKh1LtdWAsq8" target="_blank" data-icon="">Google Maps</a>
                  </div>
                </div>
              </div>
            </div>
            <div className="et_pb_section et_pb_section_4 et_pb_with_background et_section_regular">
              <div className="et_pb_with_border et_pb_row et_pb_row_5">
                <div className="et_pb_column et_pb_column_4_4 et_pb_column_5  et_pb_css_mix_blend_mode_passthrough et-last-child">
                  <div className="et_pb_module et_pb_countdown_timer et_pb_countdown_timer_0 et_animated et_pb_no_bg et_pb_bg_layout_dark" data-end-timestamp={1682874000}>
              ...
              <div className="et_pb_row et_pb_row_14">
                <div className="et_pb_column et_pb_column_4_4 et_pb_column_15  et_pb_css_mix_blend_mode_passthrough et-last-child">
                  <div className="et_pb_module et_pb_text et_pb_text_15 et_animated  et_pb_text_align_center et_pb_bg_layout_light">
                    <div className="et_pb_text_inner">
                      <p>Tinggalkan pesan/doa untuk kami <a href="https://hi.ngantenstory.com/wp-content/uploads/2023/02/Comment-Envelope.svg"><img decoding="async" loading="lazy" src="https://hi.ngantenstory.com/wp-content/uploads/2023/02/Comment-Envelope.svg" width={32} height={29} alt className="wp-image-377673 alignnone size-medium" /></a></p>
                    </div>
                  </div>
                  <div className="et_pb_with_border et_pb_module et_pb_comments_0 lang-id et_pb_comments_module et_pb_bg_layout_light et_pb_no_avatar et_pb_no_reply_button et_pb_no_comments_count" data-icon="">
                    <section id="comment-wrap">
                      ...
                      <ol className="commentlist clearfix">
                        ...
                        <li className="comment odd alt thread-odd thread-alt depth-1" id="li-comment-3">
                          <article id="comment-3" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                        ...
                        <li className="comment even thread-even depth-1" id="li-comment-4">
                          <article id="comment-4" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                              <span className="fn">Banurasmi 🥰</span> <span className="comment_date">
                                on February 14, 2023 at 8:05 pm </span>
                            </div>
                            <div className="comment_area">
                              <div className="comment-content clearfix">
                        ...
                        <li className="comment odd alt thread-odd thread-alt depth-1" id="li-comment-5">
                          <article id="comment-5" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                              <span className="fn">Cakrawala</span> <span className="comment_date">
                                on February 14, 2023 at 8:06 pm </span>
                            </div>
                            <div className="comment_area">
                              <div className="comment-content clearfix">
                        ...
                        <li className="comment even thread-even depth-1" id="li-comment-6">
                          <article id="comment-6" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                              <span className="fn">Danurdara</span> <span className="comment_date">
                                on February 14, 2023 at 8:07 pm </span>
                            </div>
                            <div className="comment_area">
                              <div className="comment-content clearfix">
                        ...
                        <li className="comment odd alt thread-odd thread-alt depth-1" id="li-comment-7">
                          <article id="comment-7" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                        ...
                        <li className="comment even thread-even depth-1" id="li-comment-8">
                          <article id="comment-8" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                              <span className="fn">Herdian</span> <span className="comment_date">
                                on February 14, 2023 at 8:08 pm </span>
                            </div>
                            <div className="comment_area">
                              <div className="comment-content clearfix">
                        ...
                        <li className="comment odd alt thread-odd thread-alt depth-1" id="li-comment-9">
                          <article id="comment-9" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                              <span className="fn">Indriaya</span> <span className="comment_date">
                                on February 14, 2023 at 8:09 pm </span>
                            </div>
                            <div className="comment_area">
                              <div className="comment-content clearfix">
                        ...
                        <li className="comment even thread-even depth-1" id="li-comment-10">
                          <article id="comment-10" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                        ...
                        <li className="comment odd alt thread-odd thread-alt depth-1" id="li-comment-11">
                          <article id="comment-11" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                              <span className="fn">Karunia</span> <span className="comment_date">
                                on February 14, 2023 at 8:10 pm </span>
                            </div>
                            <div className="comment_area">
                              <div className="comment-content clearfix">
                        ...
                        <li className="comment even thread-even depth-1" id="li-comment-12">
                          <article id="comment-12" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                            ...
                            <div className="comment_area">
                              <div className="comment-content clearfix">
                                <p>❤️ Happy wedding! ❤️ Sudah enggak ada lagi galau
                                  meratapi status jomblo, ya? Berbahagialah
                                  selalu, dan semoga segera diberkahi dengan
                                  momongan.❤️❤️❤️</p>
                              </div>
                            </div>
                          </article>
                        </li>{/* #comment-## */}
                        <li className="comment odd alt thread-odd thread-alt depth-1" id="li-comment-13">
                          <article id="comment-13" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                              <span className="fn">Manika</span> <span className="comment_date">
                                on February 14, 2023 at 8:11 pm </span>
                            </div>
                            <div className="comment_area">
                              <div className="comment-content clearfix">
                        ...
                        <li className="comment even thread-even depth-1" id="li-comment-14">
                          <article id="comment-14" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                              <span className="fn">Nareswara</span> <span className="comment_date">
                                on February 14, 2023 at 8:12 pm </span>
                            </div>
                            <div className="comment_area">
                              <div className="comment-content clearfix">
                        ...
                        <li className="comment odd alt thread-odd thread-alt depth-1" id="li-comment-15">
                          <article id="comment-15" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                        ...
                        <li className="comment even thread-even depth-1" id="li-comment-16">
                          <article id="comment-16" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                              <span className="fn">Pramudya 🥰</span> <span className="comment_date">
                                on February 14, 2023 at 8:13 pm </span>
                            </div>
                            <div className="comment_area">
                              <div className="comment-content clearfix">
                        ...
                        <li className="comment odd alt thread-odd thread-alt depth-1" id="li-comment-17">
                          <article id="comment-17" className="comment-body clearfix">
                            <div className="comment_avatar">
                            </div>
                            <div className="comment_postinfo">
                            ...
                            <div className="comment_area">
                              <div className="comment-content clearfix">
                                <p>Selamat menikah, selamat menjalani kehidupan
                                  pernikahan. Semoga Tuhan selalu menjaga kalian
                                  dan anak-anak kelak. 😘😘</p>
                              </div>
                            </div>
                          </article>
                        </li>{/* #comment-## */}
