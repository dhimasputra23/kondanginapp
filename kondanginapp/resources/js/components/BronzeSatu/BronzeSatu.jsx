...
<div id="page-container">
  <div id="main-content">
    <article id="post-20204022" className="post-20204022 page type-page status-publish has-post-thumbnail hentry">
      <div className="entry-content">
        <div className="et-l et-l--post">
          <div className="et_builder_inner_content et_pb_gutters3">
            ...
            <div className="et_pb_section et_pb_section_1 et_pb_with_background et_section_regular" style={{ backgroundImage: `linear-gradient(180deg, rgba(255, 255, 255, 0) 58%, rgba(0, 0, 0, 0.45) 100%),url("${a && a.fotoBackgrounds.some(el => (el.flag == "Background-2")) ? a.fotoBackgrounds.find(el => {return el.flag == "Background-2"}).url : ''}")` }}>
                    ...
                    <div className="et_pb_module_inner">
                      <h1>
                        <svg id="dvmdtpsvg" width={130} height="100%" viewBox="0 -17.5 130 17.5">
                          <path id="jEeHWfWUTsVaVmZtoGlGkRbBvTOAxFGd" className="mainPath" d="M0 0 C43.333333333333 -23.333333333333 86.666666666667 -23.333333333333 130 0 " />
                          ...
                          <text dy="-0.1em" dx="2px 2px 2px 2px 2px 2px 2px 2px 2px 2px 2px ">
                            <textPath id="textPath" xlinkHref="#jEeHWfWUTsVaVmZtoGlGkRbBvTOAxFGd" startOffset="50%">Our Wedding</textPath>
                          </text>
                        </svg>
                      </h1>
                    </div>
            ...
            <div className="et_pb_section et_pb_section_2 et_pb_with_background et_section_regular">
              <div className="et_pb_with_border et_pb_row et_pb_row_3">
            ...
            <div className="et_pb_section et_pb_section_3 et_section_regular">
              <div className="et_pb_with_border et_pb_row et_pb_row_4">
                <div className="et_pb_column et_pb_column_4_4 et_pb_column_4  et_pb_css_mix_blend_mode_passthrough et-last-child">
                  ...
                  <div className="et_pb_module et_pb_blurb et_pb_blurb_3 et_animated  et_pb_text_align_center  et_pb_blurb_position_top et_pb_bg_layout_light">
                    <div className="et_pb_blurb_content">
                      <div className="et_pb_blurb_container">
            ...
            <div className="et_pb_section et_pb_section_5 et_pb_with_background et_section_regular">
              ...
              <div className="et_pb_row et_pb_row_7 two-columns">
            ...
            <div className="et_pb_with_border et_pb_section et_pb_section_9 et_section_regular section_has_divider et_pb_bottom_divider">
        ...
        <article id="post-20204022" className="post-20204022 page type-page status-publish hentry">
            <div className="entry-content">
                <div className="et-l et-l--post">
                    ...
                    <div id="hadiah" className="et_pb_section et_pb_section_6 popup et_section_regular">
...
export default BronzeSatu

if (document.getElementById('bronzeSatu')) {
  ReactDOM.render(
      <Provider store={store}>
          <BronzeSatu />
      </Provider>

      , document.getElementById('bronzeSatu'));
}