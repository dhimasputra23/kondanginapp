                                    ...
                                    <div id="welcome-gate" className="et_pb_section et_pb_section_0 et_animated et_pb_with_background et_section_regular">
                                      ...
                                      <div class='amazingaudioplayer-info-description'>%INFO%</div>" data-jsfolder="https://ngantenstory.com/wp-content/plugins/wonderplugin-audio/engine/" style={{ display: 'block', position: 'relative', margin: '0 auto', width: 48, height: 'auto' }}>
                                                            <ul className="amazingaudioplayer-audios" style={{ display: 'none' }}>
                                                                <li data-artist data-title="John Mayer Youre Gonna Live Forever in Me" data-album data-info="&quot;John Mayer Youre Gonna Live Forever in Me&quot;." data-image="https://ngantenstory.com/wp-includes/images/media/audio.png" data-duration={185}>
                                                                    <div className="amazingaudioplayer-source" data-src="https://ngantenstory.com/wp-content/uploads/2022/01/John-Mayer-Youre-Gonna-Live-Forever-in-Me.mp3" data-type="audio/mpeg" />
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="et_pb_module_inner">
                                                        <h1>
                                                            <svg id="dvmdtpsvg" width={130} height="100%" viewBox="0 -17.5 130 17.5">
                                                                <path id="fGbdjPZjcCdGWogsqJWIkuxsnTkGLegt" className="mainPath" d="M0 0 C43.333333333333 -23.333333333333 86.666666666667 -23.333333333333 130 0 " />
                                                                ...
                                                                <text dy="-0.1em" dx="2px 2px 2px 2px 2px 2px 2px 2px 2px 2px 2px ">
                                                                    <textPath id="textPath" xlinkHref="#fGbdjPZjcCdGWogsqJWIkuxsnTkGLegt" startOffset="50%">Our Wedding</textPath>
                                                                </text>
                                                            </svg>
                                                        </h1>
                                                    </div>
                                    ...
                                    <div className="et_pb_section et_pb_section_2 et_section_regular">
                                        <div className="et_pb_row et_pb_row_3">
                                            <div className="et_pb_column et_pb_column_4_4 et_pb_column_3  et_pb_css_mix_blend_mode_passthrough et-last-child">
                                                ...
                                                <div className="et_pb_module et_pb_divider et_pb_divider_1 et_pb_divider_position_center et_pb_space">
                                                    <div className="et_pb_divider_internal" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="et_pb_row et_pb_row_4 two-columns et_pb_equal_columns">
                                                ...
                                                <div className="et_pb_module et_pb_blurb et_pb_blurb_0 et_animated  et_pb_text_align_right  et_pb_blurb_position_top et_pb_bg_layout_light">
                                                    <div className="et_pb_blurb_content">
                                                        <div className="et_pb_blurb_container">
                                                            <h4 className="et_pb_module_header"><span>Destya Sukma</span></h4>
                                                            <div className="et_pb_blurb_description">
                                                                <p><strong>Putri dari</strong><br />Bpk. <span>Heri
                                                                    Kusnandar</span><br />&amp; Ibu H<span>any
                                                                        Fitriani</span></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="et_pb_column et_pb_column_1_2 et_pb_column_5  et_pb_css_mix_blend_mode_passthrough et-last-child">
                                                <div className="et_pb_module et_pb_image et_pb_image_0 et_animated et-waypoint">
                                                    <span className="et_pb_image_wrap "><img decoding="async" width={400} height={400} src="../wp-content/uploads/2022/12/silver4-2.png" alt title="silver4 (2)" srcSet="https://ngantenstory.com/wp-content/uploads/2022/12/silver4-2.png 400w, https://ngantenstory.com/wp-content/uploads/2022/12/silver4-2-300x300.png 300w, https://ngantenstory.com/wp-content/uploads/2022/12/silver4-2-150x150.png 150w" sizes="(max-width: 400px) 100vw, 400px" className="wp-image-378648" /></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="et_pb_row et_pb_row_5 two-columns et_pb_equal_columns">
                                            <div className="et_pb_column et_pb_column_1_2 et_pb_column_6  et_pb_css_mix_blend_mode_passthrough">
                                                <div className="et_pb_module et_pb_image et_pb_image_1 et_animated et-waypoint">
                                                    <span className="et_pb_image_wrap "><img decoding="async" loading="lazy" width={400} height={400} src="../wp-content/uploads/2022/12/silver4-1.png" alt title="silver4 (1)" srcSet="https://ngantenstory.com/wp-content/uploads/2022/12/silver4-1.png 400w, https://ngantenstory.com/wp-content/uploads/2022/12/silver4-1-300x300.png 300w, https://ngantenstory.com/wp-content/uploads/2022/12/silver4-1-150x150.png 150w" sizes="(max-width: 400px) 100vw, 400px" className="wp-image-378646" /></span>
                                                </div>
                                            </div>
                                            <div className="et_pb_column et_pb_column_1_2 et_pb_column_7  et_pb_css_mix_blend_mode_passthrough et-last-child">
                                                <div className="et_pb_module et_pb_blurb et_pb_blurb_1 et_animated  et_pb_text_align_left  et_pb_blurb_position_top et_pb_bg_layout_light">
                                                    <div className="et_pb_blurb_content">
                                                        <div className="et_pb_blurb_container">
                                                            <h4 className="et_pb_module_header"><span>Aldo Saputra</span></h4>
                                                            <div className="et_pb_blurb_description">
                                                                <p><strong>Putra dari</strong><br />Bpk. <span>Ibnu
                                                                    Arianto</span><br />&amp; Ibu Laras Suryani</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="et_pb_row et_pb_row_6 et_animated">
                                            <div className="et_pb_column et_pb_column_1_2 et_pb_column_8  et_pb_css_mix_blend_mode_passthrough">
                                                ...
                                                <div className="et_pb_module et_pb_text et_pb_text_5 et_animated  et_pb_text_align_center et_pb_bg_layout_light">
                                                    <div className="et_pb_text_inner">
                                                        <p><strong>Sabtu, 17 Juni 2023<br /></strong>17:00 s/d 22:00
                                                            WIB<br /><strong>Sultan Convention Center</strong><br /><span>Jl.
                                                                Sultan M. Mansyur No.7 Bukit Lama, Palembang</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="et_pb_column et_pb_column_1_2 et_pb_column_9  et_pb_css_mix_blend_mode_passthrough et-last-child">
                                                ...
                                                <div className="et_pb_with_border et_pb_module et_pb_comments_0 lang-id et_pb_comments_module et_pb_bg_layout_light et_pb_no_avatar et_pb_no_reply_button et_pb_no_comments_count" data-icon="">
                                                    <section id="comment-wrap">
                                                        ...
                                                        <ol className="commentlist clearfix">
                                                            <li className="comment even thread-even depth-1 et-pb-non-builder-comment" id="li-comment-197932">
                                                                <article id="comment-197932" className="comment-body clearfix">
                                                            ...
                                                            <li className="comment odd alt thread-odd thread-alt depth-1 et-pb-non-builder-comment" id="li-comment-197916">
                                                                <article id="comment-197916" className="comment-body clearfix">
                                                                    <div className="comment_avatar">
                                                                    </div>
                                                                    <div className="comment_postinfo">
                                                            ...
                                                            <li className="comment even thread-even depth-1 et-pb-non-builder-comment" id="li-comment-197900">
                                                                <article id="comment-197900" className="comment-body clearfix">
                                                                    <div className="comment_avatar">
                                                                    </div>
                                                                    <div className="comment_postinfo">
                                                            ...
                                                            <li className="comment odd alt thread-odd thread-alt depth-1 et-pb-non-builder-comment" id="li-comment-197884">
                                                                <article id="comment-197884" className="comment-body clearfix">
                                                                    <div className="comment_avatar">
                                                                    </div>
                                                                    <div className="comment_postinfo">
                                                            ...
                                                            <li className="comment even thread-even depth-1 et-pb-non-builder-comment" id="li-comment-197868">
                                                                <article id="comment-197868" className="comment-body clearfix">
                                                                    <div className="comment_avatar">
                                                                    </div>
                                                                    <div className="comment_postinfo">
                                                            ...
                                                            <li className="comment odd alt thread-odd thread-alt depth-1 et-pb-non-builder-comment" id="li-comment-197852">
                                                                <article id="comment-197852" className="comment-body clearfix">
                                                                    <div className="comment_avatar">
                                                                    </div>
                                                                    <div className="comment_postinfo">
                                                            ...
                                                            <li className="comment even thread-even depth-1 et-pb-non-builder-comment" id="li-comment-197836">
                                                                <article id="comment-197836" className="comment-body clearfix">
                                                                    <div className="comment_avatar">
                                                                    </div>
                                                                    <div className="comment_postinfo">
                                                            ...
                                                            <li className="comment odd alt thread-odd thread-alt depth-1 et-pb-non-builder-comment" id="li-comment-197827">
                                                                <article id="comment-197827" className="comment-body clearfix">
                                                                    <div className="comment_avatar">
                                                                    </div>
                                                                    <div className="comment_postinfo">
                                                                        <span className="fn">Indriaya</span> <span className="comment_date">
                                                                            on January 2, 2023 at 12:22 am </span>
                                                                    </div>
                                                                    <div className="comment_area">
                                                                        <div className="comment-content clearfix">
                                                            ...
                                                            <li className="comment even thread-even depth-1 et-pb-non-builder-comment" id="li-comment-197804">
                                                                <article id="comment-197804" className="comment-body clearfix">
                                                                    <div className="comment_avatar">
                                                                    </div>
                                                                    <div className="comment_postinfo">
                                                            ...
                                                            <li className="comment odd alt thread-odd thread-alt depth-1 et-pb-non-builder-comment" id="li-comment-197795">
                                                                <article id="comment-197795" className="comment-body clearfix">
                                                                    <div className="comment_avatar">
                                                                    </div>
                                                                    <div className="comment_postinfo">
                                                                        <span className="fn">Karunia</span> <span className="comment_date">
                                                                            on January 2, 2023 at 12:10 am </span>
                                                                    </div>
                                                                    <div className="comment_area">
                                                                        <div className="comment-content clearfix">
                                                            ...
                                                            <li className="comment even thread-even depth-1 et-pb-non-builder-comment" id="li-comment-197771">
                                                                <article id="comment-197771" className="comment-body clearfix">
                                                                    <div className="comment_avatar">
                                                                    </div>
                                                                    <div className="comment_postinfo">
                                                            ...
                                                            <li className="comment odd alt thread-odd thread-alt depth-1 et-pb-non-builder-comment" id="li-comment-197755">
                                                                <article id="comment-197755" className="comment-body clearfix">
                                                                    <div className="comment_avatar">
                                                                    </div>
                                                                    <div className="comment_postinfo">
                                                            ...
                                                            <li className="comment even thread-even depth-1 et-pb-non-builder-comment" id="li-comment-197739">
                                                                <article id="comment-197739" className="comment-body clearfix">
                                                                    <div className="comment_avatar">
                                                                    </div>
                                                                    <div className="comment_postinfo">
                                                            ...
                                                            <li className="comment odd alt thread-odd thread-alt depth-1 et-pb-non-builder-comment" id="li-comment-197723">
                                                                <article id="comment-197723" className="comment-body clearfix">
                                                                    <div className="comment_avatar">
                                                                    </div>
                                                                    <div className="comment_postinfo">
                                                            ...
                                                            <li className="comment even thread-even depth-1 et-pb-non-builder-comment" id="li-comment-197709">
                                                                <article id="comment-197709" className="comment-body clearfix">
                                                                    <div className="comment_avatar">
                                                                    </div>
                                                                    <div className="comment_postinfo">
                                                            ...
                                                            <li className="comment odd alt thread-odd thread-alt depth-1 et-pb-non-builder-comment" id="li-comment-197691">
                                                                <article id="comment-197691" className="comment-body clearfix">
                                                                    <div className="comment_avatar">
                                                                    </div>
                                                                    <div className="comment_postinfo">
                                                                        <span className="fn">❤️ Raditya ❤️</span> <span className="comment_date">
                                                                            on January 1, 2023 at 11:51 pm </span>
                                                                    </div>
                                                                    <div className="comment_area">
                                                                        <div className="comment-content clearfix">
...
export default SilverDua

if (document.getElementById('silverdua')) {
    ReactDOM.render(<SilverDua />, document.getElementById('silverdua'));
}