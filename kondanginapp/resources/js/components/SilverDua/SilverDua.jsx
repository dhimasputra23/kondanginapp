                        ...
                        <div className="entry-content">
                            <div className="et-l et-l--post">
                                <div className="et_builder_inner_content et_pb_gutters3">
                                        ...
                                        <div className="et_pb_row et_pb_row_4 two-columns et_pb_equal_columns">
                                                    ...
                                                    <div className="et_pb_blurb_content">
                                                        <div className="et_pb_blurb_container">
                                                            ...
                                                            <div className="et_pb_blurb_description">
                                                                ...
                                                                <br />&amp; Ibu {a ? <span>{state.undangan.data.profilPasangans[1].nama_ibu}</span> : []}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="et_pb_column et_pb_column_1_2 et_pb_column_5  et_pb_css_mix_blend_mode_passthrough et-last-child">
                                                <div className="et_pb_module et_pb_image et_pb_image_0 et_animated et-waypoint">
                                                    <span className="et_pb_image_wrap "><img decoding="async" width={400} height={400} src={`${a?a.profilPasangans[1].url_foto:''}`}  title="silver4 (2)" srcSet={`${a?a.profilPasangans[1].url_foto:''} 400w, ${a?a.profilPasangans[1].url_foto:''} 300w, ${a?a.profilPasangans[1].url_foto:''} 150w`} sizes="(max-width: 400px) 100vw, 400px" className="wp-image-378648" /></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="et_pb_row et_pb_row_5 two-columns et_pb_equal_columns">
                                            <div className="et_pb_column et_pb_column_1_2 et_pb_column_6  et_pb_css_mix_blend_mode_passthrough">
                                                <div className="et_pb_module et_pb_image et_pb_image_1 et_animated et-waypoint">
                                                    <span className="et_pb_image_wrap "><img decoding="async" loading="lazy" width={400} height={400} src={`${a?a.profilPasangans[0].url_foto:''}`}  title="silver4 (1)" srcSet={`${a?a.profilPasangans[0].url_foto:''} 400w, ${a?a.profilPasangans[0].url_foto:''} 300w, ${a?a.profilPasangans[0].url_foto:''} 150w`} sizes="(max-width: 400px) 100vw, 400px" className="wp-image-378646" /></span>
                                                </div>
                                            </div>
                                                ...
                                                <div className="et_pb_module et_pb_blurb et_pb_blurb_1 et_animated  et_pb_text_align_left  et_pb_blurb_position_top et_pb_bg_layout_light">
                                                    <div className="et_pb_blurb_content">
                                                        <div className="et_pb_blurb_container">
                                                            ...
                                                            <div className="et_pb_blurb_description">
                                                                <p><strong>Putra dari</strong><br />Bpk. {a ? <span>{state.undangan.data.profilPasangans[0].nama_bapak}</span> : []}
                                                                <br />&amp; Ibu {a ? state.undangan.data.profilPasangans[0].nama_ibu : []}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="et_pb_section et_pb_section_4 et_pb_with_background et_section_regular section_has_divider et_pb_bottom_divider et_pb_top_divider" style={{ overflow: 'hidden', backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.36) 0%, rgb(100, 89, 71) 100%),url("${a && a.fotoBackgrounds.some(el => (el.flag == "Background-4")) ? a.fotoBackgrounds.find(el => {return el.flag == "Background-4"}).url : ''}")` }}>
...
if (document.getElementById('silverdua')) {
    ...
    , document.getElementById('silverdua'));
}